  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "opacity 0.5s ease, transform 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)",
        background: hovered
      ...
      >
        ...
        >
          {iconMap[icon] ? (
            ...
            <i
              className={`pi ${icon}`}
              style={{ fontSize: "18px", color: "rgba(99,102,241,0.6)" }}
            />
          )}
        </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        textAlign: "center",
        boxShadow: hovered
          ? "0 16px 40px rgba(168,85,247,0.15)"
          : "0 4px 16px rgba(0,0,0,0.2)",
        backdropFilter: "blur(12px)",
      }}
    >
...
const Skills = () => {
  ...
  const softSkills = [
    {
      ...
      icon: "pi-users",
      description:
        "Collaborate effectively in Agile teams, contributing to sprint goals and supporting teammates.",
    },
    {
      name: "Communication",
      icon: "pi-comments",
      description:
        "Communicate technical ideas clearly to both technical and non-technical stakeholders.",
    },
    {
      name: "Problem Solving",
      icon: "pi-lightbulb",
      description:
        "Break down complex problems into manageable solutions with structured debugging.",
    },
    {
      name: "Agile / Scrum",
      icon: "pi-refresh",
      description:
        "Experienced in sprint planning, daily stand-ups, and delivering features on schedule.",
    },
    {
      name: "Time Management",
      icon: "pi-clock",
      description:
        "Prioritize tasks effectively, meet deadlines, and manage parallel workstreams.",
    },
    {
      name: "Self-Learning",
      icon: "pi-book",
      description:
        "Continuously learn new technologies and apply them quickly in real-world projects.",
    },
  ];

  const stats = [
    { label: "Technologies", value: 10, suffix: "+", icon: "pi-code" },
    { label: "Projects Built", value: 3, suffix: "+", icon: "pi-box" },
    { label: "Months Experience", value: 12, suffix: "+", icon: "pi-calendar" },
    { label: "GitHub Commits", value: 100, suffix: "+", icon: "pi-github" },
  ];

  const categoryTabs = [
    { id: "technical", label: "Technical", icon: "pi-code", iconKey: "code" },
    { id: "tools", label: "Tools", icon: "pi-cog", iconKey: "setting" },
    {
      id: "soft",
      label: "Soft Skills",
      icon: "pi-users",
  ...
  const currentGroups =
    activeCategory === "technical" ? technicalGroups : toolsGroups;
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          >
            <span style={{ color: "#f1f5f9" }}>My Skills &</span>
            <span
              style={{
                background:
          ...
          >
            An overview of the skills and technologies I have learned and
